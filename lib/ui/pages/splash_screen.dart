...
import 'package:quotes_app/Animation/FadeAnimation.dart';
import 'package:page_transition/page_transition.dart';
import 'package:quotes_app/ui/pages/quote_screen.dart';
...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _scale2Animation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.fade, child: QuoteScreen()));
      }
    });
  }
